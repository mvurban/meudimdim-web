...
import { getAcoes, setAcoes, getInstitutions, mockPrecos } from '@/lib/mock-store'
      ...
      <div style={cardStyle}>
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {items.length === 0 && (
              <tr>
                <td colSpan={8} style={{ textAlign: 'center', padding: '32px 0', fontSize: 13, color: 'var(--text-muted)' }}>
